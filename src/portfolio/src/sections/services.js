...
const SERVICES_DATA = [
  {
    ...
    text:
      'Looking for a Frontend Developer who can handle complex problems and solve them with ease? ',
  },
  {
    icon: icon2,
    title: 'Product Ownership',
    text:
      'I take full ownership of the product and ensure that it is delivered on time with the best practices',
  },
  {
    icon: icon3,
  ...
  },
  {
    ...
    title: '5X speed',
    text:
      'Using AI tools, I am able to deliver the project 5X faster than the traditional way',
  },
];
  ...
  return (
    <Box sx={styles.services} id="services">
      <Container>
        <BlockTitle
          slogan="Services"
          title="Looking for one the following?"
